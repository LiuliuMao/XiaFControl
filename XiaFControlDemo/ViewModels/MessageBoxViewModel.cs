...
namespace XiaFControlDemo.ViewModels
{
    ...
    {
        private DelegateCommand<object> messageBoxShow;
        public DelegateCommand<object> MessageBoxShow => messageBoxShow ?? (messageBoxShow = new DelegateCommand<object>(MessageBoxShowExecute));
        ...
        private DelegateCommand<object> messageBoxShowContainer;
        public DelegateCommand<object> MessageBoxShowContainer => messageBoxShowContainer ?? (messageBoxShowContainer = new DelegateCommand<object>(MessageBoxShowContainerExecute));
