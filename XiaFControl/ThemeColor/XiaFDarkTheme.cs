...
{
    public class XiaFDarkTheme : IBaseTheme
    {
        public  Color ThemeForegroundColor { get;set; } = (Color)ColorConverter.ConvertFromString("#E6E6E6");

        public  Color ThemeBackgroundColor { get;set; } = (Color)ColorConverter.ConvertFromString("#252526");

        public  Color WindowBackgroundColor { get;set; } = (Color)ColorConverter.ConvertFromString("#1C1C1C");
